...
Welcome to the source code of the Ramon Magsaysay (Cubao) High School microsites.
...
To start a development server, open the terminal with the current directory set here, the run:
```
npm run dev
```
